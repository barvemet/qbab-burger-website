...
CREATE DATABASE IF NOT EXISTS qbab_burger CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE qbab_burger;
...
-- Chat messages table (for automated responses tracking)
...
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@qbab-burger.de');
...
('site_email', 'info@qbab-burger.de'),
...
('facebook_url', ''),
('instagram_url', ''),
('notification_email', 'orders@qbab-burger.de'),
('notification_phone', '');
...
'Pazartesi''den Pazar''a 11:00 - 22:00 saatleri arasında açığız.', 1),
